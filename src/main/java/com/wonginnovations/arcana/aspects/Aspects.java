...
import static com.wonginnovations.arcana.aspects.ColorRange.create;
...
//	}
	...
	public static List<Aspect> getWithoutEmpty() {
		return getAll().stream().filter(aspect -> !aspect.equals(EMPTY) && !aspect.equals(DUMMY)).toList();
	}
	...
	public static List<Aspect> getPrimals() {
		return List.of(AIR, CHAOS, FIRE, EARTH, ORDER, WATER);
	}
	
	public static void init() {
		StartupMessageManager.addModMessage("Arcana: Aspect registration completed");
	}
}