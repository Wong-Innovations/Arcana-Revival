...
public class ArcanaConfig {
	...
	static {
		...
		PHIALSHELF_COLOR = CLIENT_BUILDER
				.comment("The color scheme used by phialshelves.", "Ranged 0-5, with higher numbers being darker and 0 being disabled.", "3 by default.")
				.define("PhialshelfColor", 3);
	...
	public static ConfigValue<Integer> WAND_HUD_X; // 5
	public static ConfigValue<Integer> WAND_HUD_Y; // 5
	...
	public static ConfigValue<Integer> PHIALSHELF_COLOR; // 3
