...
public class ConfigResearch {
    ...
    private static void initCategories() {
        ResearchCategories.registerCategory("BASICS", null, new AspectList().add(Aspect.PLANT, 5).add(Aspect.ORDER, 5).add(Aspect.ENTROPY, 5).add(Aspect.AIR, 5).add(Aspect.FIRE, 5).add(Aspect.EARTH, 3).add(Aspect.WATER, 5), new ResourceLocation(Arcana.MODID, "textures/item/thaumonomicon_cheat.png"), new ResourceLocation(Arcana.MODID, "textures/gui/gui_research_back_1.jpg"), ConfigResearch.BACK_OVER);
