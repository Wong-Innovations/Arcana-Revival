...
public class ModConfig {
    ...
    public static void register(ModLoadingContext context) {
        context.registerConfig(Type.CLIENT, CONFIG_GRAPHICS, "arcana_graphics.toml");
        context.registerConfig(Type.COMMON, CONFIG_WORLD, "arcana_world.toml");
        context.registerConfig(Type.COMMON, CONFIG_MISC, "arcana_misc.toml");
    }
