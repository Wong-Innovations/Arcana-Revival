...
public class ShapedArcaneRecipeBuilder implements RecipeBuilder {
    ...
    @Override
    public @NotNull ShapedArcaneRecipeBuilder unlockedBy(@NotNull String pCriterionName, @NotNull CriterionTriggerInstance pCriterionTrigger) {
        this.advancement.addCriterion(pCriterionName, pCriterionTrigger);
        return this;
    }

    @Override
    public @NotNull ShapedArcaneRecipeBuilder group(@Nullable String pGroupName) {
