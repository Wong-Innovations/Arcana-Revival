...
//        } catch (Exception ex) {
//        }
        return (b && (research == null || ModCapabilities.getKnowledge(player).isResearchKnown(research))) ? new Placement(0, 0, 0, null) : null;
    }
    ...
    public void execute(Level world, Player player, BlockPos pos, Placement placement, Direction facing) {
        ...
        ServerEvents.addRunnableServer(world, () -> ServerEvents.addSwapper(world, pos, state, result, false, 0, player, true, true, -9999, false, false, 0, ServerEvents.DEFAULT_PREDICATE, 0.0f), 50);
    }
}
