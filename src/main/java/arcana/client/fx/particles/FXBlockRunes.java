package arcana.client.fx.particles;
...
public class FXBlockRunes extends TextureSheetParticle {
    ...
    @Override
    public void render(@NotNull VertexConsumer wr, Camera pRenderInfo, float pPartialTicks) {
        ...
        Quaternionf quat = Axis.YP.rotationDegrees(rotation);
        Quaternionf quat1 = Axis.ZP.rotationDegrees(90.0f);
        ...
        wr.vertex(avector3f[0].x(), avector3f[0].y(), avector3f[0].z()).uv(var17, var19).color(this.rCol, this.gCol, this.bCol, this.alpha / 2.0f).uv2(j).endVertex();
        wr.vertex(avector3f[1].x(), avector3f[1].y(), avector3f[1].z()).uv(var17, var18).color(this.rCol, this.gCol, this.bCol, this.alpha / 2.0f).uv2(j).endVertex();
        wr.vertex(avector3f[2].x(), avector3f[2].y(), avector3f[2].z()).uv(var16, var18).color(this.rCol, this.gCol, this.bCol, this.alpha / 2.0f).uv2(j).endVertex();
        wr.vertex(avector3f[3].x(), avector3f[3].y(), avector3f[3].z()).uv(var16, var19).color(this.rCol, this.gCol, this.bCol, this.alpha / 2.0f).uv2(j).endVertex();
    }
    ...
    public @NotNull ParticleRenderType getRenderType() {
        return new ParticleRenderType() {
            public void begin(@NotNull BufferBuilder buffer, @NotNull TextureManager textureManager) {
