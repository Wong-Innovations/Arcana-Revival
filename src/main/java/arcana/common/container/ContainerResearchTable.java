...
import arcana.common.container.slot.SlotLimitedByClass;
import arcana.common.container.slot.SlotLimitedByItemstack;
...
public class ContainerResearchTable extends AbstractContainerMenu {
    ...
    @Override
    public boolean clickMenuButton(@NotNull Player pPlayer, int button) {
        if (button == 1) {
    ...
    @Override
    public @NotNull ItemStack quickMoveStack(@NotNull Player pPlayer, int slot) {
