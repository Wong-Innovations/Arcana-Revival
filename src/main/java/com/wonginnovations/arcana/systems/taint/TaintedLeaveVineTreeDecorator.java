...
public class TaintedLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
	...
	public void func_225576_a_(ILevel level, Random random, List<BlockPos> lp0, List<BlockPos> lp1, Set<BlockPos> blockPositions, MutableBoundingBox box) {
		lp1.forEach((current) -> {
	...
	protected void func_227424_a_(IWorldWriter p_227424_1_, BlockPos p_227424_2_, BooleanProperty p_227424_3_, Set<BlockPos> p_227424_4_, MutableBoundingBox p_227424_5_) {
		this.func_227423_a_(p_227424_1_, p_227424_2_, ArcanaBlocks.TAINTED_VINE.get().defaultBlockState().with(p_227424_3_, Boolean.valueOf(true)), p_227424_4_, p_227424_5_);
	}
}
*/