...
public class CustomTextStyle{
	...
	public CustomTextStyle(int color, boolean bold, boolean italics, boolean underline, boolean obfuscated, boolean wavy, float size, boolean shadow, boolean strikethrough, boolean subscript, boolean superscript) {
		this.color = color;
		this.bold = bold;
	...
	public CustomTextStyle(CustomTextStyle in) {
		this(in.color, in.bold, in.italics, in.underline, in.obfuscated, in.wavy, in.size, in.shadow, in.strikethrough, in.subscript, in.superscript);
	}
	...
	public CustomTextStyle setColor(int color) {
		this.color = color;
		return this;
	}
