package com.wonginnovations.arcana.systems.spell.modules;
...
public abstract class SpellModule {
	...
	// Generates a CompoundTag representing this module, including bound modules.
	...
	// Fills this module with values from a CompoundTag
	public void fromNBT(CompoundTag compound) {
		x = compound.getInt("x");
		y = compound.getInt("y");
	}

	// Writes the values of this module to the input CompoundTag and returns it.
	...
	public void renderUnderMouse(GuiGraphics guiGraphics, int x, int y, boolean floating) { }
