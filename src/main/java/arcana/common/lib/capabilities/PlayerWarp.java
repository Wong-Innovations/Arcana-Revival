...
public class PlayerWarp {
    private static class DefaultImpl implements IPlayerWarp {
        ...
        @Override
        public void set(final @NotNull EnumWarpType type, final int amount) {
    ...
    public static class Provider implements ICapabilitySerializable<CompoundTag> {
        public static final ResourceLocation NAME = new ResourceLocation("arcana", "warp");
        ...
        public @NotNull <T> LazyOptional<T> getCapability(@NotNull Capability<T> capability, @Nullable Direction side) {
            if (capability == ModCapabilities.WARP) {
