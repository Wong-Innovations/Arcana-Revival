package com.wonginnovations.arcana.client.renderers.entity;
...
public class RenderSpecialItem extends ItemEntityRenderer {
    ...
    public void render(ItemEntity e, float pEntityYaw, float pt, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
        ...
        for (int i = 0; i < q; ++i) {
            pMatrixStack.mulPose(new Quaternionf(1.0F, 0.0F, 0.0F, random.nextFloat() * 360.0F));
            pMatrixStack.mulPose(new Quaternionf(1.0F, 0.0F, 0.0F, random.nextFloat() * 360.0F));
            pMatrixStack.mulPose(new Quaternionf(0.0F, 1.0F, 0.0F, random.nextFloat() * 360.0F));
            pMatrixStack.mulPose(new Quaternionf(0.0F, 0.0F, 1.0F, random.nextFloat() * 360.0F));
            pMatrixStack.mulPose(new Quaternionf(1.0F, 0.0F, 0.0F, random.nextFloat() * 360.0F));
            pMatrixStack.mulPose(new Quaternionf(0.0F, 1.0F, 0.0F, random.nextFloat() * 360.0F));
            pMatrixStack.mulPose(new Quaternionf(0.0F, 0.0F, 1.0F, random.nextFloat() * 360.0F + f1 * 360.0F));
            ...
            wr.vertex(matrix4f, 0.866f * f4, fa, (-0.5f * f4)).color(1.0f, 0.0f, 1.0f, 0.0f).endVertex();
            wr.vertex(matrix4f, 0.0f, fa, (f4)).color(1.0f, 0.0f, 1.0f, 0.0f).endVertex();
            wr.vertex(matrix4f, -0.866f * f4, fa, (-0.5f * f4)).color(1.0f, 0.0f, 1.0f, 0.0f).endVertex();
        }
