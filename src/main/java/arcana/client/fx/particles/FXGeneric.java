...
public class FXGeneric extends TextureSheetParticle {
    ...
    @Override
    public void render(@NotNull VertexConsumer wr, @NotNull Camera camera, float partialTicks) {
        if (this.loop) {
    ...
    public void draw(VertexConsumer wr, Camera camera, float partialTicks) {
        ...
        if (this.angled) {
            ...
            quaternion = new Quaternionf().rotateXYZ((float) Math.toRadians(this.anglePitch + 90.0f), (float) Math.toRadians(-this.angleYaw + 90.0f), (float) Math.toRadians(f3 * 57.29577951308232f));
        ...
        wr.vertex(avector3f[0].x(), avector3f[0].y(), avector3f[0].z()).uv(tx2, ty2).color(pr, pg, pb, this.alpha).uv2(j, k).endVertex();
        wr.vertex(avector3f[1].x(), avector3f[1].y(), avector3f[1].z()).uv(tx2, ty1).color(pr, pg, pb, this.alpha).uv2(j, k).endVertex();
        wr.vertex(avector3f[2].x(), avector3f[2].y(), avector3f[2].z()).uv(tx1, ty1).color(pr, pg, pb, this.alpha).uv2(j, k).endVertex();
        wr.vertex(avector3f[3].x(), avector3f[3].y(), avector3f[3].z()).uv(tx1, ty2).color(pr, pg, pb, this.alpha).uv2(j, k).endVertex();
    }
    ...
    public void setParticle(int startParticle) {
        this.setParticles(startParticle, 1, 1);
    }
    ...
    public void setHasPhysics(boolean has) {
        this.hasPhysics = has;
    }
}